    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="is_show">
                <input type="checkbox" name="is_show" data-id="@{{ d.id }}" lay-skin="switch"  lay-filter="is_show" @{{ d.is_show ==0?"checked":""}}>
            </script>
        </div>
    </div>
@endsection
        ...
        layui.use(['layer','table','form'],function () {
            ...
            var dataTable = table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{ field: 'is_show', title: '显隐', templet: '#is_show', style: "text-align:left", align: "center" , totalRow: true }
            ...
            form.on('switch(is_show)', function (obj) {
                var alert_value = this.checked ? '0' : '1'; //设置1为开启，0为关闭
                // var orgid = $(this).attr("data-orgid");
                var id = $(this).attr("data-id");
                // console.log(1111,alert_value,orgid,id);
                // return false;
                var url1="{{ route('admin.permission') }}"
