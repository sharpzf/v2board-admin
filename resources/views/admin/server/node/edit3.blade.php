            ...
            <form class="layui-form" action="{{route('admin.node.update',['id'=>$node['id']])}}" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="margin-right: 0px;width: 30%;">
                        <input type="number" name="up_mbps" lay-verify="required"  value="{{ isset($node)?$node['up_mbps']:''}}"  placeholder="请根据实际网络情况尽量准确地填写" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="margin-right: 0px;width: 30%;">
                        <input type="number" name="down_mbps" lay-verify="required"  value="{{ isset($node)?$node['down_mbps']:''}}"  placeholder="请根据实际网络情况尽量准确地填写" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline" >
                        <button class="layui-btn layui-btn-disabled">Mbps</button>
                        {{--<input type="text" name="email_prefix" placeholder="@" class="layui-input layui-btn layui-btn-disabled">--}}
